...
class Question extends  \Magento\Backend\Block\Widget\Grid\Column\Renderer\Text {
	...
	public function render(\Magento\Framework\DataObject $row) {
		...
		$string .= '<br/><div class="';
		$string .= ($row->getAnswers()) ? 'itorisqa_red' : 'itorisqa_blue';
		$string .= '">(' . $row->getAnswers() . ' ' .__('answers') .')</div>';
		return $string;
	}
}
