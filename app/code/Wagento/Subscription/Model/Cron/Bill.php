...
use Wagento\Subscription\Model\ResourceModel\SubscriptionSales\Grid\CollectionFactory;
...
class Bill
{
    ...
    protected function getActiveSubscriptions()
    {
        ...
        $subscriptions->addFieldToFilter('next_renewed', ['eq' => $currentDate])
                ...
                try {
                    ...
                    if (isset($result['success'])) {
                        try {
                            ...
                            $salesSubModel = $this->subscriptionSales->load($subscription->getId());
