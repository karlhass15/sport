    ...
    pjQuery_1_11_3(function () {
        ...
        pjQuery_1_11_3('ul#sortable-visible, ul#sortable-hidden').sortable({
            ...
            update: function (event, ui) {
                ...
                pjQuery_1_11_3('#psloginpro_general_sortable').val(sortable.join('&'));
            },
        ...
        if (pjQuery_1_11_3('#psloginpro_general_sortable_drag_and_drop').css('display') != 'none') {
            if (pjQuery_1_11_3('#psloginpro_general_sortable_inherit').length) {
                pjQuery_1_11_3('#psloginpro_general_sortable_inherit').on('change', function () {
            ...
            pjQuery_1_11_3('#row_psloginpro_general_sortable').hide();
        }
