...
class TemplateAdminNotification implements \Magento\Framework\Option\ArrayInterface
{
    const EMAIL_TEMPLATE_ID='itoris_email_productqa_admin';
    ...
    public function toOptionArray()
    {
        ...
        $templ[]=['value' => self::EMAIL_TEMPLATE_ID, 'label' => __('New question added for Admin (default)')];
        if($data){
