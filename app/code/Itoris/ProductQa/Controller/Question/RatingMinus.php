...
class RatingMinus extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            return $result->setData(['success' => true,'count'=>$questionsModel->addRating($questionId, $this->getCustomerSession()->getCustomerId(), '-1', $remoteIp)]);
        } catch(\Exception $e) {
