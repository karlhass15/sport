    ...
    public function execute()
    {
        ...
        try {
            ...
            if ($getIsEnable == 1 && $getIsSelectChangeStatusEmail == 1) {
                ...
                $emailTempVariables = $this->emailHelper->getStatusEmailVariables($id, $status, $customerId);
                ...
                $this->messageManager->addSuccessMessage(__('Subscription Profile #%1 Cancelled Successfully.', $id));
            }
