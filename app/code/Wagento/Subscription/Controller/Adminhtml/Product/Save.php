    ...
    public function execute()
    {
        ...
        if ($data) {
            try {
                ...
                if ($data['product']['subscription_configurate'] != 'no') {
                    $this->productFactory = $this->productFactory->create();

                    $this->productFactory->load($productId, 'product_id');

                    $this->productFactory->setProductId($product->getId());
                    $this->productFactory->setSubscriptionId($data['product']['subscription_attribute_product']);

                    $this->productFactory->setProductQty(1);
