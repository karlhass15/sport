...
class Data extends Main
{
    ...
    public function getPhotoPath($checkIsEnabled = true, $customerId = null, $type = null)
    {
        ...
        if ($type !== null) {
            ...
            $pathUrl = $this->store->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) .'pslogin/photo/' . $type . DIRECTORY_SEPARATOR . $customerId .'.'. \Plumrocket\SocialLoginPro\Model\Account::PHOTO_FILE_EXT;
        ...
        $pathUrl = $this->store->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) .'pslogin/photo/' . $customerId .'.'. \Plumrocket\SocialLoginPro\Model\Account::PHOTO_FILE_EXT;
    ...
    public function getCallbackURL($provider, $byRequest = false)
    {
        ...
        $url = $this->storeManager->getStore($defaultStoreId)->getUrl('pslogin/account/login', ['type' => $provider, 'key' => null, '_nosid' => true]);
