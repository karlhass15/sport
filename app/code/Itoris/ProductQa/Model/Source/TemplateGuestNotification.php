...
class TemplateGuestNotification implements \Magento\Framework\Option\ArrayInterface
{
    const EMAIL_TEMPLATE_ID='itoris_email_productqa_guest';
    ...
    public function toOptionArray()
    {
        ...
        $templ[]=['value' => self::EMAIL_TEMPLATE_ID, 'label' => __('New answer added for Guest (default)')];
        if($data){
